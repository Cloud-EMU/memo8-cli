...
export function printMemoryList(memories: Memory[]): void {
...
export function printTagList(tags: Tag[]): void {
  if (tags.length === 0) {
    info('No tags found.');
    return;
  }
...
export function printMemoryDetail(memory: Memory): void {
  console.log();
...
export function printTagDetail(tag: Tag): void {
  console.log();
...
// Pagination
export function printPagination(meta?: PaginationMeta): void {
...
// Stats
export function printStats(title: string, stats: StatsData): void {
  console.log();
