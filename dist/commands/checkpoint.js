...
export function registerCheckpointCommands(program) {
    ...
    checkpoint
        ...
        try {
            ...
            if (opts.task)
                payload.task_id = Number(opts.task);
            if (opts.description)
                payload.description = opts.description;
            const { data } = await api.post(`/projects/${projectId}/checkpoints`, payload);
            spinner.stop();
    ...
    checkpoint
        ...
        try {
            ...
            const { data } = await api.get(`/projects/${projectId}/checkpoints`, params);
            spinner.stop();
    ...
    checkpoint
        ...
        try {
            ...
            const api = createApiClient();
            const { data } = await api.get(`/projects/${projectId}/checkpoints/${id}`);
            spinner.stop();
            const cp = data.data;
            console.log();
    ...
    checkpoint
        ...
        try {
            ...
            const api = createApiClient();
            const { data } = await api.post(`/projects/${projectId}/checkpoints/${id}/rollback-instructions`);
            spinner.stop();
