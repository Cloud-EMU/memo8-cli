...
export function registerConventionCommands(program) {
    ...
    convention
        ...
        try {
            ...
            const { data } = await api.get(`/projects/${projectId}/conventions`, params);
            spinner.stop();
    ...
    convention
        ...
        try {
            ...
            if (codeExample)
                payload.code_example = codeExample;
            if (antiPatternExample)
                payload.anti_pattern_example = antiPatternExample;
            const { data } = await api.post(`/projects/${projectId}/conventions`, payload);
            spinner.stop();
    ...
    convention
        ...
        try {
            ...
            const api = createApiClient();
            const { data } = await api.get(`/projects/${projectId}/conventions/${id}`);
            spinner.stop();
            const c = data.data;
            console.log();
    ...
    convention
        ...
        try {
            ...
            const api = createApiClient();
            const { data } = await api.post(`/projects/${projectId}/conventions/check`, { file_path: file, content });
            spinner.stop();
            if (data.data.length === 0) {
